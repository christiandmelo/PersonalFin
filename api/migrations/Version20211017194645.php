 ...
 */
final class Version20211017194645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, suggested_category_id INT NOT NULL, name VARCHAR(100) NOT NULL, short_name VARCHAR(50) NOT NULL, active TINYINT(1) NOT NULL, INDEX IDX_64C19C119EB6921 (client_id), INDEX IDX_64C19C1DD17DE90 (suggested_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, suggested_payment_id INT NOT NULL, name VARCHAR(100) NOT NULL, initials VARCHAR(4) NOT NULL, active TINYINT(1) NOT NULL, INDEX IDX_6D28840D19EB6921 (client_id), INDEX IDX_6D28840DEF15488D (suggested_payment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
